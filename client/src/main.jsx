...
function App() {
  ...
  return <main className="min-h-screen bg-slate-950 text-slate-100"><div className="mx-auto max-w-6xl px-6 py-14">
    <header className="mb-12"><p className="mb-3 text-sm font-semibold uppercase tracking-[.2em] text-cyan-400">Local extraction milestone</p><h1 className="text-4xl font-bold tracking-tight sm:text-5xl">Order extraction,<br/><span className="text-slate-400">with visible local fallbacks.</span></h1><p className="mt-5 max-w-2xl text-slate-400">Upload a sales or purchase order PDF. Review the extracted fields before any future production hand-off.</p></header>
